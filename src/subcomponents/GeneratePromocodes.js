...
export default function GeneratePromocodes(props){
    ...
    return  <div>
                <ReactModal 
                    isOpen={props.showGenerateCodes}
                    className="Modal"
                    overlayClassName="Overlay"
                    contentLabel="Minimal Modal Example">
                    <h4 className="text-center">Create Promocode</h4>
                    <br/>
                    <div className="row">
                    ...
                    <br/>
                    <button className="laser-inline blue-bg bt-btn" style={btn_style_left} onClick={e => props.generateClicked(e)}>Create</button>
